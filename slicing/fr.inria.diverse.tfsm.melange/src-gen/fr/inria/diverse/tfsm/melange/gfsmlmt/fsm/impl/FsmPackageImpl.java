/**
 */
package fr.inria.diverse.tfsm.melange.gfsmlmt.fsm.impl;
...
import fr.inria.diverse.tfsm.melange.gfsmlmt.gfsm.impl.GfsmPackageImpl;
...
public class FsmPackageImpl extends EPackageImpl implements FsmPackage {
	 ...
	 * @see fr.inria.diverse.tfsm.melange.gfsmlmt.fsm.FsmPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	public static FsmPackage init() {
		...
		GfsmPackageImpl theGfsmPackage = (GfsmPackageImpl)(EPackage.Registry.INSTANCE.getEPackage(GfsmPackage.eNS_URI) instanceof GfsmPackageImpl ? EPackage.Registry.INSTANCE.getEPackage(GfsmPackage.eNS_URI) : GfsmPackage.eINSTANCE);
	...
	public void initializePackageContents() {
		...
		initEClass(fsmEClass, fr.inria.diverse.tfsm.melange.gfsmlmt.fsm.FSM.class, "FSM", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getFSM_States(), this.getState(), this.getState_Fsm(), "states", null, 0, -1, fr.inria.diverse.tfsm.melange.gfsmlmt.fsm.FSM.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getFSM_Transitions(), this.getTransition(), this.getTransition_Fsm(), "transitions", null, 0, -1, fr.inria.diverse.tfsm.melange.gfsmlmt.fsm.FSM.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getFSM_Initialstate(), this.getInitialState(), null, "initialstate", null, 1, 1, fr.inria.diverse.tfsm.melange.gfsmlmt.fsm.FSM.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getFSM_Name(), ecorePackage.getEString(), "name", "", 0, 1, fr.inria.diverse.tfsm.melange.gfsmlmt.fsm.FSM.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
