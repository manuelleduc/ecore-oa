...
public class TransitionAdapter extends /* EObjectAdapter<fr.inria.diverse.tfsm.melange.gfsml.fsm.Transition> */ implements Transition {
  ...
  public void setFrom(final State o) {
    if (o != null)
    	adaptee.setFrom(((fr.inria.diverse.tfsm.melange.gfsml.adapters.fsmlmt.fsm.StateAdapter) o).getAdaptee());
  ...
  public void setTo(final State o) {
    if (o != null)
    	adaptee.setTo(((fr.inria.diverse.tfsm.melange.gfsml.adapters.fsmlmt.fsm.StateAdapter) o).getAdaptee());
