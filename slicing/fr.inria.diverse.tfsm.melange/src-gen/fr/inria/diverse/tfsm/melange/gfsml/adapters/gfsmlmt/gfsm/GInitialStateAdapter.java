...
public class GInitialStateAdapter extends /* EObjectAdapter<fr.inria.diverse.tfsm.melange.gfsml.gfsm.GInitialState> */ implements GInitialState {
  private fr.inria.diverse.tfsm.melange.gfsml.adapters.gfsmlmt.GFSMLMTAdaptersFactory adaptersFactory;
  
  public GInitialStateAdapter() {
  ...
  public EClass eClass() {
    return fr.inria.diverse.tfsm.melange.gfsmlmt.gfsm.GfsmPackage.eINSTANCE.getGInitialState();
  }
  
  @Override
  public Object eGet(final int featureID, final boolean resolve, final boolean coreType) {
    switch (featureID) {
    	case fr.inria.diverse.tfsm.melange.gfsmlmt.gfsm.GfsmPackage.GINITIAL_STATE__NAME:
    		return getName();
    	case fr.inria.diverse.tfsm.melange.gfsmlmt.gfsm.GfsmPackage.GINITIAL_STATE__FSM:
    		return getFsm();
    	case fr.inria.diverse.tfsm.melange.gfsmlmt.gfsm.GfsmPackage.GINITIAL_STATE__OUTGOINGTRANSITIONS:
    		return getOutgoingtransitions();
    	case fr.inria.diverse.tfsm.melange.gfsmlmt.gfsm.GfsmPackage.GINITIAL_STATE__INCOMMINGTRANSITIONS:
    		return getIncommingtransitions();
    	case fr.inria.diverse.tfsm.melange.gfsmlmt.gfsm.GfsmPackage.GINITIAL_STATE__IN_EXPRESSION:
    		return getInExpression();
    	case fr.inria.diverse.tfsm.melange.gfsmlmt.gfsm.GfsmPackage.GINITIAL_STATE__OUT_EXPRESSION:
