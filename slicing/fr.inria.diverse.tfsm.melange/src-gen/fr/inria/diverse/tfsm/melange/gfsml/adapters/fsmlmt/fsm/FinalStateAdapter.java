package fr.inria.diverse.tfsm.melange.gfsml.adapters.fsmlmt.fsm;
...
public class FinalStateAdapter extends /* EObjectAdapter<fr.inria.diverse.tfsm.melange.gfsml.fsm.FinalState> */ implements FinalState {
  private fr.inria.diverse.tfsm.melange.gfsml.adapters.fsmlmt.FSMlMTAdaptersFactory adaptersFactory;
  
  public FinalStateAdapter() {
    super(fr.inria.diverse.tfsm.melange.gfsml.adapters.fsmlmt.FSMlMTAdaptersFactory.getInstance());
    adaptersFactory = fr.inria.diverse.tfsm.melange.gfsml.adapters.fsmlmt.FSMlMTAdaptersFactory.getInstance();
  }
  ...
  public void setFsm(final FSM o) {
    if (o != null)
    	adaptee.setFsm(((fr.inria.diverse.tfsm.melange.gfsml.adapters.fsmlmt.fsm.FSMAdapter) o).getAdaptee());
  ...
  public EClass eClass() {
    return fr.inria.diverse.tfsm.melange.fsmlmt.fsm.FsmPackage.eINSTANCE.getFinalState();
  }
  
  @Override
  public Object eGet(final int featureID, final boolean resolve, final boolean coreType) {
    switch (featureID) {
    	case fr.inria.diverse.tfsm.melange.fsmlmt.fsm.FsmPackage.FINAL_STATE__NAME:
    		return getName();
    	case fr.inria.diverse.tfsm.melange.fsmlmt.fsm.FsmPackage.FINAL_STATE__FSM:
    		return getFsm();
    	case fr.inria.diverse.tfsm.melange.fsmlmt.fsm.FsmPackage.FINAL_STATE__OUTGOINGTRANSITIONS:
    		return getOutgoingtransitions();
    	case fr.inria.diverse.tfsm.melange.fsmlmt.fsm.FsmPackage.FINAL_STATE__INCOMMINGTRANSITIONS:
