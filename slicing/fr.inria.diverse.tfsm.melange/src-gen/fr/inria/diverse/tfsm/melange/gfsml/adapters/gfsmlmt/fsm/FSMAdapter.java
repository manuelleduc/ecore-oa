...
public class FSMAdapter extends /* EObjectAdapter<fr.inria.diverse.tfsm.melange.gfsml.fsm.FSM> */ implements FSM {
  ...
  public EClass eClass() {
    return fr.inria.diverse.tfsm.melange.gfsmlmt.fsm.FsmPackage.eINSTANCE.getFSM();
  }
  
  @Override
  public Object eGet(final int featureID, final boolean resolve, final boolean coreType) {
    switch (featureID) {
    	case fr.inria.diverse.tfsm.melange.gfsmlmt.fsm.FsmPackage.FSM__STATES:
    		return getStates();
    	case fr.inria.diverse.tfsm.melange.gfsmlmt.fsm.FsmPackage.FSM__TRANSITIONS:
    		return getTransitions();
    	case fr.inria.diverse.tfsm.melange.gfsmlmt.fsm.FsmPackage.FSM__INITIALSTATE:
    		return getInitialstate();
    	case fr.inria.diverse.tfsm.melange.gfsmlmt.fsm.FsmPackage.FSM__NAME:
    		return getName();
    }
