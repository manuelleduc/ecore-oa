...
public class ConstExprAdapter extends /* EObjectAdapter<fr.inria.diverse.tfsm.melange.gfsml.expression.ConstExpr> */ implements ConstExpr {
  ...
  public EClass eClass() {
    return fr.inria.diverse.tfsm.melange.gfsmlmt.expression.ExpressionPackage.eINSTANCE.getConstExpr();
  }
  
  @Override
  public Object eGet(final int featureID, final boolean resolve, final boolean coreType) {
    switch (featureID) {
    	case fr.inria.diverse.tfsm.melange.gfsmlmt.expression.ExpressionPackage.CONST_EXPR__VALUE:
