...
public class GFinalStateAdapter extends /* EObjectAdapter<fr.inria.diverse.tfsm.melange.gfsml.gfsm.GFinalState> */ implements GFinalState {
  private fr.inria.diverse.tfsm.melange.gfsml.adapters.gfsmlmt.GFSMLMTAdaptersFactory adaptersFactory;
  
  public GFinalStateAdapter() {
  ...
  public EClass eClass() {
    return fr.inria.diverse.tfsm.melange.gfsmlmt.gfsm.GfsmPackage.eINSTANCE.getGFinalState();
  }
  
  @Override
  public Object eGet(final int featureID, final boolean resolve, final boolean coreType) {
    switch (featureID) {
    	case fr.inria.diverse.tfsm.melange.gfsmlmt.gfsm.GfsmPackage.GFINAL_STATE__NAME:
    		return getName();
    	case fr.inria.diverse.tfsm.melange.gfsmlmt.gfsm.GfsmPackage.GFINAL_STATE__FSM:
    		return getFsm();
    	case fr.inria.diverse.tfsm.melange.gfsmlmt.gfsm.GfsmPackage.GFINAL_STATE__OUTGOINGTRANSITIONS:
    		return getOutgoingtransitions();
    	case fr.inria.diverse.tfsm.melange.gfsmlmt.gfsm.GfsmPackage.GFINAL_STATE__INCOMMINGTRANSITIONS:
    		return getIncommingtransitions();
    	case fr.inria.diverse.tfsm.melange.gfsmlmt.gfsm.GfsmPackage.GFINAL_STATE__IN_EXPRESSION:
    		return getInExpression();
    	case fr.inria.diverse.tfsm.melange.gfsmlmt.gfsm.GfsmPackage.GFINAL_STATE__OUT_EXPRESSION:
