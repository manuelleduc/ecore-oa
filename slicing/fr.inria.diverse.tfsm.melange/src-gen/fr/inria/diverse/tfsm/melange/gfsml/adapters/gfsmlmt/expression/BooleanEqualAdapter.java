...
public class BooleanEqualAdapter extends /* EObjectAdapter<fr.inria.diverse.tfsm.melange.gfsml.expression.BooleanEqual> */ implements BooleanEqual {
  ...
  public EClass eClass() {
    return fr.inria.diverse.tfsm.melange.gfsmlmt.expression.ExpressionPackage.eINSTANCE.getBooleanEqual();
  }
  
  @Override
  public Object eGet(final int featureID, final boolean resolve, final boolean coreType) {
    switch (featureID) {
    	case fr.inria.diverse.tfsm.melange.gfsmlmt.expression.ExpressionPackage.BOOLEAN_EQUAL__EXPRESSION1:
    		return getExpression1();
    	case fr.inria.diverse.tfsm.melange.gfsmlmt.expression.ExpressionPackage.BOOLEAN_EQUAL__EXPRESSION2:
