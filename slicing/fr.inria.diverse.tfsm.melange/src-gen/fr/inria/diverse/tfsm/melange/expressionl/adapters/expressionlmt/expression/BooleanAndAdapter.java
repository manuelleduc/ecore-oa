...
public class BooleanAndAdapter extends /* EObjectAdapter<fr.inria.diverse.tfsm.melange.expressionl.expression.BooleanAnd> */ implements BooleanAnd {
  ...
  public void setBoolExpression1(final BooleanExpression o) {
    if (o != null)
    	adaptee.setBoolExpression1(((fr.inria.diverse.tfsm.melange.expressionl.adapters.expressionlmt.expression.BooleanExpressionAdapter) o).getAdaptee());
  ...
  public void setBoolExpression2(final BooleanCompareExpression o) {
    if (o != null)
    	adaptee.setBoolExpression2(((fr.inria.diverse.tfsm.melange.expressionl.adapters.expressionlmt.expression.BooleanCompareExpressionAdapter) o).getAdaptee());
    else adaptee.setBoolExpression2(null);
  }
  
  @Override
  public EClass eClass() {
    return fr.inria.diverse.tfsm.melange.expressionlmt.expression.ExpressionPackage.eINSTANCE.getBooleanAnd();
  }
  
  @Override
  public Object eGet(final int featureID, final boolean resolve, final boolean coreType) {
    switch (featureID) {
    	case fr.inria.diverse.tfsm.melange.expressionlmt.expression.ExpressionPackage.BOOLEAN_AND__BOOL_EXPRESSION1:
    		return getBoolExpression1();
    	case fr.inria.diverse.tfsm.melange.expressionlmt.expression.ExpressionPackage.BOOLEAN_AND__BOOL_EXPRESSION2:
