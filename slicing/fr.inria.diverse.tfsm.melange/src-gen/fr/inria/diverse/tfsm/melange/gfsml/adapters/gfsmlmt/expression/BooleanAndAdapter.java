...
import fr.inria.diverse.tfsm.melange.gfsmlmt.expression.BooleanCompareExpression;
import fr.inria.diverse.tfsm.melange.gfsmlmt.expression.BooleanExpression;
import org.eclipse.emf.ecore.EClass;

@SuppressWarnings("all")
public class BooleanAndAdapter extends /* EObjectAdapter<fr.inria.diverse.tfsm.melange.gfsml.expression.BooleanAnd> */ implements BooleanAnd {
  private fr.inria.diverse.tfsm.melange.gfsml.adapters.gfsmlmt.GFSMLMTAdaptersFactory adaptersFactory;
  
  public BooleanAndAdapter() {
  ...
  public void setBoolExpression1(final BooleanExpression o) {
    if (o != null)
    	adaptee.setBoolExpression1(((fr.inria.diverse.tfsm.melange.gfsml.adapters.gfsmlmt.expression.BooleanExpressionAdapter) o).getAdaptee());
  ...
  public void setBoolExpression2(final BooleanCompareExpression o) {
    if (o != null)
    	adaptee.setBoolExpression2(((fr.inria.diverse.tfsm.melange.gfsml.adapters.gfsmlmt.expression.BooleanCompareExpressionAdapter) o).getAdaptee());
    else adaptee.setBoolExpression2(null);
  }
  
  @Override
  public EClass eClass() {
    return fr.inria.diverse.tfsm.melange.gfsmlmt.expression.ExpressionPackage.eINSTANCE.getBooleanAnd();
  }
  
  @Override
  public Object eGet(final int featureID, final boolean resolve, final boolean coreType) {
    switch (featureID) {
    	case fr.inria.diverse.tfsm.melange.gfsmlmt.expression.ExpressionPackage.BOOLEAN_AND__BOOL_EXPRESSION1:
    		return getBoolExpression1();
    	case fr.inria.diverse.tfsm.melange.gfsmlmt.expression.ExpressionPackage.BOOLEAN_AND__BOOL_EXPRESSION2:
  ...
  public void eSet(final int featureID, final Object newValue) {
    switch (featureID) {
    	...
    	case fr.inria.diverse.tfsm.melange.gfsmlmt.expression.ExpressionPackage.BOOLEAN_AND__BOOL_EXPRESSION2:
    		setBoolExpression2(
    		(fr.inria.diverse.tfsm.melange.gfsmlmt.expression.BooleanCompareExpression)
    		 newValue);
    		return;
    }
