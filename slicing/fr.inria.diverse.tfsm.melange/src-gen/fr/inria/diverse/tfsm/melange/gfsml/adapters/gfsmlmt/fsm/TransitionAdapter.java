...
public class TransitionAdapter extends /* EObjectAdapter<fr.inria.diverse.tfsm.melange.gfsml.fsm.Transition> */ implements Transition {
  ...
  public EClass eClass() {
    return fr.inria.diverse.tfsm.melange.gfsmlmt.fsm.FsmPackage.eINSTANCE.getTransition();
  }
  
  @Override
  public Object eGet(final int featureID, final boolean resolve, final boolean coreType) {
    switch (featureID) {
    	case fr.inria.diverse.tfsm.melange.gfsmlmt.fsm.FsmPackage.TRANSITION__FSM:
    		return getFsm();
    	case fr.inria.diverse.tfsm.melange.gfsmlmt.fsm.FsmPackage.TRANSITION__FROM:
    		return getFrom();
    	case fr.inria.diverse.tfsm.melange.gfsmlmt.fsm.FsmPackage.TRANSITION__TO:
    		return getTo();
    	case fr.inria.diverse.tfsm.melange.gfsmlmt.fsm.FsmPackage.TRANSITION__EVENT:
    		return getEvent();
    }
