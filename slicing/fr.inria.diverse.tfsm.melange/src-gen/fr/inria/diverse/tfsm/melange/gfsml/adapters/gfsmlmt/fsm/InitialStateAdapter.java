...
public class InitialStateAdapter extends /* EObjectAdapter<fr.inria.diverse.tfsm.melange.gfsml.fsm.InitialState> */ implements InitialState {
  ...
  public EClass eClass() {
    return fr.inria.diverse.tfsm.melange.gfsmlmt.fsm.FsmPackage.eINSTANCE.getInitialState();
  }
  
  @Override
  public Object eGet(final int featureID, final boolean resolve, final boolean coreType) {
    switch (featureID) {
    	case fr.inria.diverse.tfsm.melange.gfsmlmt.fsm.FsmPackage.INITIAL_STATE__NAME:
    		return getName();
    	case fr.inria.diverse.tfsm.melange.gfsmlmt.fsm.FsmPackage.INITIAL_STATE__FSM:
    		return getFsm();
    	case fr.inria.diverse.tfsm.melange.gfsmlmt.fsm.FsmPackage.INITIAL_STATE__OUTGOINGTRANSITIONS:
    		return getOutgoingtransitions();
    	case fr.inria.diverse.tfsm.melange.gfsmlmt.fsm.FsmPackage.INITIAL_STATE__INCOMMINGTRANSITIONS:
