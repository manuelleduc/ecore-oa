...
import fr.inria.diverse.tfsm.melange.gfsmlmt.expression.BooleanBinaryExpression;
...
public class BooleanBinaryExpressionAdapter extends /* EObjectAdapter<fr.inria.diverse.tfsm.melange.gfsml.expression.BooleanBinaryExpression> */ implements BooleanBinaryExpression {
  ...
  public EClass eClass() {
    return fr.inria.diverse.tfsm.melange.gfsmlmt.expression.ExpressionPackage.eINSTANCE.getBooleanBinaryExpression();
  }
  
  @Override
  public Object eGet(final int featureID, final boolean resolve, final boolean coreType) {
    switch (featureID) {
    	case fr.inria.diverse.tfsm.melange.gfsmlmt.expression.ExpressionPackage.BOOLEAN_BINARY_EXPRESSION__BOOL_EXPRESSION1:
    		return getBoolExpression1();
    	case fr.inria.diverse.tfsm.melange.gfsmlmt.expression.ExpressionPackage.BOOLEAN_BINARY_EXPRESSION__BOOL_EXPRESSION2:
