...
import fr.inria.diverse.tfsm.melange.expressionlmt.expression.IntBinaryExpression;
import fr.inria.diverse.tfsm.melange.expressionlmt.expression.IntExpression;
import org.eclipse.emf.ecore.EClass;

@SuppressWarnings("all")
public class IntBinaryExpressionAdapter extends /* EObjectAdapter<fr.inria.diverse.tfsm.melange.gfsml.expression.IntBinaryExpression> */ implements IntBinaryExpression {
  private fr.inria.diverse.tfsm.melange.gfsml.adapters.expressionlmt.ExpressionLMTAdaptersFactory adaptersFactory;
  
  public IntBinaryExpressionAdapter() {
  ...
  public void setExpression1(final IntExpression o) {
    if (o != null)
    	adaptee.setExpression1(((fr.inria.diverse.tfsm.melange.gfsml.adapters.expressionlmt.expression.IntExpressionAdapter) o).getAdaptee());
  ...
  public void setExpression2(final IntExpression o) {
    if (o != null)
    	adaptee.setExpression2(((fr.inria.diverse.tfsm.melange.gfsml.adapters.expressionlmt.expression.IntExpressionAdapter) o).getAdaptee());
    else adaptee.setExpression2(null);
  }
  
  @Override
  public EClass eClass() {
    return fr.inria.diverse.tfsm.melange.expressionlmt.expression.ExpressionPackage.eINSTANCE.getIntBinaryExpression();
  }
  
  @Override
  public Object eGet(final int featureID, final boolean resolve, final boolean coreType) {
    switch (featureID) {
    	case fr.inria.diverse.tfsm.melange.expressionlmt.expression.ExpressionPackage.INT_BINARY_EXPRESSION__EXPRESSION1:
    		return getExpression1();
    	case fr.inria.diverse.tfsm.melange.expressionlmt.expression.ExpressionPackage.INT_BINARY_EXPRESSION__EXPRESSION2:
