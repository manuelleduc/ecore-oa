...
public class FSMAdapter extends /* EObjectAdapter<fr.inria.diverse.tfsm.melange.gfsml.fsm.FSM> */ implements FSM {
  ...
  public void setInitialstate(final InitialState o) {
    if (o != null)
    	adaptee.setInitialstate(((fr.inria.diverse.tfsm.melange.gfsml.adapters.fsmlmt.fsm.InitialStateAdapter) o).getAdaptee());
