...
public class FSMlAdapter extends ResourceAdapter implements fr.inria.diverse.tfsm.melange.FSMlMT {
  public FSMlAdapter() {
  ...
  public FsmFactory getFsmFactory() {
    return new fr.inria.diverse.tfsm.melange.fsml.adapters.fsmlmt.fsm.FsmFactoryAdapter();
  }
