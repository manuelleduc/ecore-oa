...
public class IntAddAdapter extends /* EObjectAdapter<fr.inria.diverse.tfsm.melange.gfsml.expression.IntAdd> */ implements IntAdd {
  ...
  public EClass eClass() {
    return fr.inria.diverse.tfsm.melange.expressionlmt.expression.ExpressionPackage.eINSTANCE.getIntAdd();
  }
  
  @Override
  public Object eGet(final int featureID, final boolean resolve, final boolean coreType) {
    switch (featureID) {
    	case fr.inria.diverse.tfsm.melange.expressionlmt.expression.ExpressionPackage.INT_ADD__EXPRESSION1:
    		return getExpression1();
    	case fr.inria.diverse.tfsm.melange.expressionlmt.expression.ExpressionPackage.INT_ADD__EXPRESSION2:
