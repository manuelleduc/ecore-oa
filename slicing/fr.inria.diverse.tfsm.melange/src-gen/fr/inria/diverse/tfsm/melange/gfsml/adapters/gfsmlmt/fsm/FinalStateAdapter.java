...
public class FinalStateAdapter extends /* EObjectAdapter<fr.inria.diverse.tfsm.melange.gfsml.fsm.FinalState> */ implements FinalState {
  ...
  public EClass eClass() {
    return fr.inria.diverse.tfsm.melange.gfsmlmt.fsm.FsmPackage.eINSTANCE.getFinalState();
  }
  
  @Override
  public Object eGet(final int featureID, final boolean resolve, final boolean coreType) {
    switch (featureID) {
    	case fr.inria.diverse.tfsm.melange.gfsmlmt.fsm.FsmPackage.FINAL_STATE__NAME:
    		return getName();
    	case fr.inria.diverse.tfsm.melange.gfsmlmt.fsm.FsmPackage.FINAL_STATE__FSM:
    		return getFsm();
    	case fr.inria.diverse.tfsm.melange.gfsmlmt.fsm.FsmPackage.FINAL_STATE__OUTGOINGTRANSITIONS:
    		return getOutgoingtransitions();
    	case fr.inria.diverse.tfsm.melange.gfsmlmt.fsm.FsmPackage.FINAL_STATE__INCOMMINGTRANSITIONS:
