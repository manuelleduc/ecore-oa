...
public class IntVarAssignAdapter extends /* EObjectAdapter<fr.inria.diverse.tfsm.melange.gfsml.expression.IntVarAssign> */ implements IntVarAssign {
  ...
  public void setExpression(final IntExpression o) {
    if (o != null)
    	adaptee.setExpression(((fr.inria.diverse.tfsm.melange.gfsml.adapters.gfsmlmt.expression.IntExpressionAdapter) o).getAdaptee());
  ...
  public EClass eClass() {
    return fr.inria.diverse.tfsm.melange.gfsmlmt.expression.ExpressionPackage.eINSTANCE.getIntVarAssign();
  }
  
  @Override
  public Object eGet(final int featureID, final boolean resolve, final boolean coreType) {
    switch (featureID) {
    	case fr.inria.diverse.tfsm.melange.gfsmlmt.expression.ExpressionPackage.INT_VAR_ASSIGN__NAME:
    		return getName();
    	case fr.inria.diverse.tfsm.melange.gfsmlmt.expression.ExpressionPackage.INT_VAR_ASSIGN__EXPRESSION:
